...
const upcomingYear = `${year + 1}-${month}-${day}`;
const lastYear = `${year - 1}-${month}-${day}`;

const popularGames = `games?key=${process.env.REACT_APP_RAWG_API}&dates=2021-09-30,${currentDate}&ordering=-rating&page_size=8`;
